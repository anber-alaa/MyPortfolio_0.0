...
export default function DownloadBtn() {
  return (
    <a href="https://drive.google.com/file/d/1-itNVPMIcjv5nKw5EKJaxquH6F2rB6XN/view?usp=drive_link" target='blank' download="AnberAlaaCV.pdf" className="relative group cursor-pointer w-full max-w-[250px] mx-auto">
